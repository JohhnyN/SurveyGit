...
from . import models
from .models import TYPE_FIELD, Survey, Question, Answer
...
""".format(gettext("No summary"),
           gettext("Summary is available only for input type: %(input_types)s") % dict(input_types=input_types))
